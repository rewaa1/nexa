...
import WorkCardCanvas, { CanvasVariant } from "@/components/canvas/WorkCardCanvas/WorkCardCanvas";
      ...
      >
        ...
        <div className="flex flex-col gap-5">
          {PROJECTS.map((project, index) => (
            <WorkCard key={project.id} project={project} index={index} stacked />
          ))}
        </div>
      </section>
    );
  ...
  return (
    <section ref={sectionRef} id="work" style={{ height: "300vh" }}>
      ...
      >
        ...
        >
          {PROJECTS.map((project, index) => (
            <WorkCard key={project.id} project={project} index={index} stacked={false} />
          ))}
        </div>
      </div>
    </section>
